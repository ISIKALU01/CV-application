    ...
    <section className="preview-area preview-area__educ-info">
      ...
      {data.length ? (
        ...
        <div className="preview-unit__educ-info">
          <div className="preview__info-main-header">
            <div className="preview__info-main-wrapper">
              <h2 className="preview__institution">Babcock University</h2>
              <h2 className="preview__degree-program">Bsc Political Science</h2>
            </div>
            <span className="preview__active-years">Aug 2009-Jun 2015</span>
          </div>
